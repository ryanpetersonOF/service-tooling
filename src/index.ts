...
import * as webpackTools from './webpack/webpack';
import {CLIArguments, WebpackMode, BuildCommandArgs} from './types';
import {createZipProvider} from './scripts/createProviderZip';
import {createWebpackMiddleware} from './webpack/middleware';

export {webpackTools as webpack};
...
async function buildCommandProcess(args: BuildCommandArgs) {
    ...
    await createWebpackMiddleware(sanitizedArgs.mode, true);
    process.exit(0);
}
